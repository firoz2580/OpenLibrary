<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Favorite Books.aspx.vb"
    Inherits="Favorites" %>
...
<body>
    		    ...
    		    <ul class="nav navbar-nav navbar-right ">
					...
					<li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="Favorite Books.aspx">Books</a></li>
    ...
    <div class="container" runat="server" id="mainContainer">
                    ...
                    <asp:GridView ID="GridView1" CssClass="table table-hover" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Favorite">
                                <ItemTemplate>
                                    <%--<asp:Button ID="Button1" runat="server" CssClass="btn w3-button btn-primary " CommandArgument='<%# Eval("BookID") %>'
                                    ...
                                    <asp:ImageButton ID="Button1" runat="server" CssClass="img-responsive" Style="height: 32px;"
                                        CommandArgument='<%# Eval("BookID") %>' CommandName="remove" OnCommand="Button1_Command"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:firozLibraryDB %>"
            SelectCommand="SELECT BooksTable.BookID, BooksTable.bname, BooksTable.authorName, BooksTable.cat, BooksTable.subCat, BooksTable.filepath, BooksTable.type FROM BooksTable INNER JOIN favorites ON BooksTable.BookID = favorites.BookID INNER JOIN userAccounts ON favorites.email = userAccounts.email WHERE (userAccounts.email LIKE '%' + @ses_user + '%')">
            <SelectParameters>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <img id="btnmdlClose" src="img\op_exit.png" class="img-responsive" alt="X" style="float: right; height: 38px; width: 38px;" />
