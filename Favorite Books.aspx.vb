...
Partial Class Favorites
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        Else
            If e.CommandName = "view" Then
                'Response.Redirect("book viewer.aspx?embed=" & e.CommandArgument)
    ...
    Protected Sub Button1_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs)
        ...
        If e.CommandName = "remove" Then
            ...
            deleteStr = "delete from favorites where BookID=" & e.CommandArgument & " and email='" & Session("user") & "';"
            cmd = New SqlCommand(deleteStr, con)
            cmd.ExecuteNonQuery()
            Response.Redirect("Favorite Books.aspx")
        End If
    End Sub
    Private Sub func1()
        If Session("user") = "" Then
