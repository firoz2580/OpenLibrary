<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Video results.aspx.vb" Inherits="Video_results" %>
...
<head runat="server">
    ...
    $(function(){
        ...
        $('.modal-content').resizable({
            alsoResize: ".modal-body ,#myIframe",
...
<body>
    ...
    <nav class="navbar navbar-default">
    		...
    		<div class="navbar-collapse collapse" id="mainNavbar">
    		    <ul class="nav navbar-nav navbar-right ">
					...
					<li class="active"><a href="Video results.aspx" ><span class="glyphicon glyphicon-film"></span> Search a Video</a></li>
					<li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-heart"></span> Favorites<span class="caret"></span></a>
    ...
    <div class="container">
        <div class="row">
            <div class=" col-xs-10 col-xs-offset-2 col-md-3 col-md-offset-9 ">
                <div class="input-group">
                    <asp:TextBox ID="searchtxt" CssClass="form-control" placeholder="Enter Book Name"
            ...
            <div class="col-xs-12 col-md-10 col-md-offset-1">
                <div class="table-responsive img-rounded ">
                    <asp:GridView ID="GridView1" CssClass="table table-hover" runat="server" AutoGenerateColumns="False"
                        ...
                        EnableTheming="True" UseAccessibleHeader="False" EnableViewState="False" CellPadding="2"
                        BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" ForeColor="Black"
                        GridLines="None">
                        <PagerSettings FirstPageText="" LastPageText="" NextPageText="" PreviousPageText="" />
                        <Columns>
                            <asp:TemplateField HeaderText="<u>Video Title</u>" SortExpression="VideoTitle" ConvertEmptyStringToNull="False"
                                InsertVisible="True" ItemStyle-Font-Underline="False" HeaderStyle-Font-Underline="False">
                                <ItemTemplate>
                            ...
                            <asp:BoundField DataField="channel" HeaderText="Author Name" SortExpression="channel/author"
                            ...
                            <asp:BoundField DataField="subCat" HeaderText="Video about" SortExpression="subCat" />
                            <asp:TemplateField HeaderText="Favorite">
                                <ItemTemplate>
                                    <asp:ImageButton ID="Button1" runat="server" CssClass="img-responsive" Style="height: 32px;"
                                        CommandArgument='<%# Eval("VideoID") %>' CommandName="add" OnCommand="Button1_Command"
        ...
        <asp:SqlDataSource ID="AllBooks_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:firozLibraryDB %>"
            SelectCommand="SELECT * FROM [VideoTable]"></asp:SqlDataSource>
        <asp:SqlDataSource ID="ByCat_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:firozLibraryDB %>"
            SelectCommand="SELECT VideoID, VideoTitle, Channel, cat, subCat, videoLink, type FROM VideoTable WHERE (cat LIKE '%' + @cat + '%')">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="BySubCat_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:firozLibraryDB %>"
            SelectCommand="SELECT VideoID, VideoTitle, Channel, cat, subCat, videoLink, type FROM VideoTable WHERE (subCat LIKE '%' + @subCat + '%')">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="ManualSearch_SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:firozLibraryDB %>"
            SelectCommand="SELECT VideoID, VideoTitle, Channel, cat, subCat, videoLink, type FROM VideoTable WHERE (VideoTitle LIKE '%' + @VideoTitle + '%') OR (Channel LIKE '%' + @Channel + '%') OR (cat LIKE '%' + @cat + '%') OR (subCat LIKE '%' + @subCat + '%')">
            <SelectParameters>
                <asp:ControlParameter ControlID="searchtxt" Name="VideoTitle" PropertyName="Text"
                    Type="String" />
                <asp:ControlParameter ControlID="searchtxt" Name="Channel" PropertyName="Text" Type="String" />
                <asp:ControlParameter ControlID="searchtxt" Name="cat" PropertyName="Text" Type="String" />
                <asp:ControlParameter ControlID="searchtxt" Name="subCat" PropertyName="Text" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <img id="btnmdlClose" src="img\op_exit.png" class="img-responsive"
                            style="float: right; height: 38px; width: 38px;" />
                        <h4 class="modal-title" runat="server" id="modelTitle"> </h4>
                    </div>
                    <div class="modal-body img-responsive container">
                        <iframe id="myIframe" class="col-xs-12 img-responsive" alt="X" style="height: inherit;"
                            runat="server" frameborder="0" scrolling="no" />
                    </div>
                </div>
            </div>
        </div>
